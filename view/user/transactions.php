...
<div class="container">
   ...
   <div class="botones">
				...
				<div id="centrado">
					<a class='btn btn-success' value="report_month" data-toggle="modal" href="#Reporte_Mensual">Report of Month <!--<span class="fa fa-file-excel-o"></span>--></a>
				</div>
				<div id="derecha">
					<a class='btn btn-success' value="reporte" data-toggle="modal" href="#Reporte_Diario">Reporte of Day <!--<span class="fa fa-file-excel-o"></span>--></a>
				</div>							
			</div><br>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../controller/user/reports/transactions/report_month.php" method="post" id="insert_form" accept-charset="utf-8">
			...
			<div class="modal fade" id="Reporte_Diario">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../controller/user/reports/transactions/report_day.php" method="post" id="insert_form" accept-charset="utf-8">
								<label>Fecha</label>
								<div class="input-group date calendario">
